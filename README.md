...
| @cxl/gbc.compiler    | 0.0.1 | GPL-3.0    | A concise and type-safe functional language designed to prioritize immutability and modularity. It uses blocks as its core execution units to form computation pipelines. | [Docs](https://cxlio.github.io/docs/@cxl/gbc.compiler/0.0.1/) |
